---
title: "taxa during keto and non keto diet - boxplots"
...
```
rarefied L6(genus) and L7(specy) taxa
#Data prep
```{r}
#L6 genus
...
#abundances of Firmicutes,Bacteroidetes,Actinobacteria
relative, centered log ratio
```{r}
...
#interesting bacteria from heatmaps
```{r}
##L6 genus
