---
title: "correlation rarefied taxa with nutrient clusters (all,U1,U2)"
...
cl.sum.z.U1 <- cl.sum.z[grepl('U1',row.names(cl.sum.z)),]
cl.sum.z.U2 <- cl.sum.z[grepl('U2',row.names(cl.sum.z)),]

```

###biom.L6 and nutclust correlatin
relative clr taxa tables
z.score nutrient cluster table
-log10(BH p.values)

cl.sum.z kommt von biom.foods
```{r}
##merge together
...
write_tsv(cor.test.adj.L6.nutr,paste0(table_dir,'corr.nutclust.biom.L6.tsv'))
...
###biom.L7 and nutclust correlatin
```{r}
...
colnames(cor.test.adj.L7.nutr) <- c('genus','clusters','p.adj.log','estimate')

cor.test.adj.L7.nutr <- cor.test.adj.L7.nutr[cor.test.adj.L7.nutr$p.adj.log != 0 & cor.test.adj.L7.nutr$estimate != 0,]

write_tsv(cor.test.adj.L7.nutr,paste0(table_dir,'corr.nutclust.biom.L7.tsv'))

sig.nutr.L7 <- cor.test.adj.L7.nutr[cor.test.adj.L7.nutr$p.adj.log >= -log10(0.05) & cor.test.adj.L7.nutr$p.adj.log > 0.00000  ,] 
top.sig.nutr.L7 <- sig.nutr.L7[order(-sig.nutr.L7$p.adj.log ),]

```

## L6 U1 and U2 biom.L6 and nutclusts
###U1
```{r}
...
colnames(cor.test.adj.biom.L6.U1) <- c('genus','cluster','p.adj.log','estimate')

cor.test.adj.biom.L6.U1 <- cor.test.adj.biom.L6.U1[cor.test.adj.biom.L6.U1$p.adj.log != 0 & cor.test.adj.biom.L6.U1$estimate != 0,]

write_tsv(cor.test.adj.biom.L6.U1,paste0(table_dir,'corr.nutclust.biom.L6.U1.tsv'))
...
merge.biom.L6.nutr.U2 <- norm.L6.U2 %>% merge(.,cl.sum.z.U2,by = 'row.names',all.x=T,all.y = T) %>% column_to_rownames(.,'Row.names')

merge.biom.L6.nutr.U2[is.na(merge.biom.L6.nutr.U2)] <- 0

merge.biom.L6.nutr.U2$file_name <- row.names(merge.biom.L6.nutr.U2)
write_tsv(merge.biom.L6.nutr.U2,'C:/Users/Juliane/Desktop/project.directory/data/tables/corr.biom.L6.U2.nutclust.19.02.tsv',append=FALSE)
...
write_tsv(cor.test.adj.biom.L6.U2,paste0(table_dir,'corr.nutclust.biom.L6.U2.tsv'))

```

## L7 U1 and U2 biom.L7 and nutclusts
###U1 
```{r}

merge.biom.L7.nutr.U1 <- biom.L7.rel.clr.U1 %>% merge(.,cl.sum.z.U1,by = 'row.names',all.x=T,all.y = T) %>% column_to_rownames(.,'Row.names')

merge.biom.L7.nutr.U1[is.na(merge.biom.L7.nutr.U1)] <- 0

merge.biom.L7.nutr.U1$file_name <- row.names(merge.biom.L7.nutr.U1)
write_tsv(merge.biom.L7.nutr.U1,'C:/Users/Juliane/Desktop/project.directory/data/tables/corr.biom.L7.U1.nutclust.19.02.tsv',append=FALSE)
...
colnames(cor.test.adj.biom.L7.U1) <- c('specy','cluster','p.adj.log','estimate')

cor.test.adj.biom.L7.U1 <- cor.test.adj.biom.L7.U1[cor.test.adj.biom.L7.U1$p.adj.log != 0 & cor.test.adj.biom.L7.U1$estimate != 0,]

write_tsv(cor.test.adj.biom.L7.U1,paste0(table_dir,'corr.nutclust.biom.L7.U1.tsv'))
...
merge.biom.L7.nutr.U2 <- biom.L7.rel.clr.U2 %>% merge(.,cl.sum.z.U2,by = 'row.names',all.x=T,all.y = T) %>% column_to_rownames(.,'Row.names')

merge.biom.L7.nutr.U2[is.na(merge.biom.L7.nutr.U2)] <- 0

merge.biom.L7.nutr.U2$file_name <- row.names(merge.biom.L7.nutr.U2)
write_tsv(merge.biom.L7.nutr.U2,'C:/Users/Juliane/Desktop/project.directory/data/tables/corr.biom.L7.U1.nutclust.19.02.tsv',append=FALSE)
...
colnames(cor.test.adj.biom.L7.U2) <- c('specy','cluster','p.adj.log','estimate')

cor.test.adj.biom.L7.U2 <- cor.test.adj.biom.L7.U2[cor.test.adj.biom.L7.U2$p.adj.log != 0 & cor.test.adj.biom.L7.U2$estimate != 0,]

write_tsv(cor.test.adj.biom.L7.U2,paste0(table_dir,'corr.nutclust.biom.L7.U2.tsv'))
```